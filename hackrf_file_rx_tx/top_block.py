...
# Title: Top Block
# Generated: Thu Dec 29 01:33:17 2016
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/james/Desktop/gnuradio_projects/hackrf_am_file_rx/capture', True)

        ##################################################
        # Connections
        ##################################################
        self.connect((self.blocks_file_source_0, 0), (self.high_pass_filter_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.high_pass_filter_0.set_taps(firdes.high_pass(1, self.samp_rate, 200e3, 50e3, firdes.WIN_HAMMING, 6.76))
    ...
    def set_amplitude(self, amplitude):
        ...
        self.mult.set_k((self.amplitude, ))
